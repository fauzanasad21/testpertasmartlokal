...
def calculate_dryness(pressure, temperature, flow):
    ...
    if model_gbr is None:
        try:
            ...
            PATH_GBR_MODEL = "D:/Kuliah/GithubLokalDua/tespertasmartlokal/Model Dryness Maks100/GBR_model.pkl"
            PATH_GBR_SCALER = "D:/Kuliah/GithubLokalDua/tespertasmartlokal/Model Dryness Maks100/GBR_scaler.pkl"
            PATH_TWALL_MODEL = "D:/Kuliah/GithubLokalDua/tespertasmartlokal/Model Dryness Maks100/Twall_model.pkl"
            PATH_TWALL_SCALER = "D:/Kuliah/GithubLokalDua/tespertasmartlokal/Model Dryness Maks100/Twall_scaler.pkl"
    ...
    try:
        # Konversi tekanan dari Barg ke Bar Absolut sesuai permintaan
        pressure_abs = pressure + 0.95
        # === LANGKAH 1: Prediksi Twall ===
        twall_input_df = pd.DataFrame([{'Pressure': pressure_abs, 'Temperature': temperature, 'Flow': flow}])
        ...
        pressure_pa = pressure_abs * 100000
